...
public class HTTPURL {
    ...
    public String getContentBySocket(String domain) throws IOException, InterruptedException, ExecutionException {
        ...
        try {
            ...
            SocketAddress endpoint = new InetSocketAddress(domain, 80);
            //SocketAddress endpoint = new InetSocketAddress("nhe0.blogspot.com", 80);
            connection.connect(endpoint, 1000);
...
//            return buffer.toString();
            ...
            this.writer.println(ex.toString());
            return null;
        }
